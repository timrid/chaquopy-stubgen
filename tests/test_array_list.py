...
hint:     def [_ArrayList__E] ArrayList(self, int | jint | Integer, /) -> ArrayList[_ArrayList__E]
hint:     def [_ArrayList__E] ArrayList(self, Collection[_ArrayList__E], /) -> ArrayList[_ArrayList__E]""",
    }
