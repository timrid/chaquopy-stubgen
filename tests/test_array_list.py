...
hint:     def add(self, index: int | jint | Integer, element: str) -> None""",
    }
...
hint:     def [_ArrayList__E] ArrayList(self, initialCapacity: int | jint | Integer) -> ArrayList[_ArrayList__E]
hint:     def [_ArrayList__E] ArrayList(self, c: Collection[_ArrayList__E]) -> ArrayList[_ArrayList__E]""",
    }
