...
def test_bitarray_stub_is_valid(mypy_project_dir: Path):
    code = """\
...
def test_mangled_methods_are_generated(mypy_project_dir: Path):
    code = """\
from java.util import BitSet
...
def test_no_unmangled_methods_are_generated_and(mypy_project_dir: Path):
    code = """\
from java.util import BitSet
...
def test_no_unmangled_methods_are_generated_or(mypy_project_dir: Path):
    code = """\
from java.util import BitSet
